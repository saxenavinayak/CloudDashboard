...
### Postgres Container
When running postgres in a container, we can mount a storage from the physical drive. So all data storage is persisted, even when you restart a container.
